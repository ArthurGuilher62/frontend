...
return (
  <footer className="App-footer">
    ...
    <ul className="navigation__footer">
        ...
        <li><a className="navigation__footer__link" href="/SobreProjeto" target="_blank" rel="noopener noreferrer">Sobre o projeto</a></li>
        <li><a className="navigation__footer__link" href="/SobreNos" target="_blank" rel="noopener noreferrer">Sobre nós</a></li>
      </ul>
    <div>
